  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="OpenAI Function Calling: 0 to AI Agent. 노코드/로우코드로 실무 수준의 AI 자동화 파이프라인을 구축하세요." />
      </Helmet>
      <Navbar />
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="flex flex-col items-center mb-24 animate-fade-in relative">
            <div className="text-center max-w-3xl mb-12">
              ...
              <p className="text-2xl text-foreground font-bold mb-4">OpenAI Function Calling: 0 to AI Agent</p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Chatling으로 배우는 챗봇 개념부터 OpenAI 기반 진짜 AI Agent까지.<br/>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle>Chatbot Basics</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base">
                    Chatling 플랫폼을 활용해 코딩 없이도 Knowledge Base와 조건 분기가 가능한 챗봇 기본 개념을 2시간 만에 완성합니다.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle>OpenAI AI Agent</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base">
                    OpenAI Function Calling을 활용하여 AI가 스스로 함수를 선택하고 실행하는 '행동하는' 지능형 Agent를 만듭니다.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <CardDescription className="text-base">
                    과정 종료 시, 'OpenAI 기반 쇼핑몰 AI Agent'라는 완성된 포트폴리오를 확보합니다.
                  </CardDescription>
                </CardContent>
              </Card>
            </div>
          ...
          <section className="mb-32">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <h3 className="text-xl font-semibold mb-6 text-primary">챗봇 기본 개념 마스터</h3>
                <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
                  나만의 쇼핑몰에 AI 직원을 채용하세요. Chatling 플랫폼의 핵심 블록을 조립하여 챗봇의 기본 개념을 빠르게 습득합니다.
                </p>
          ...
          {/* Week 2: OpenAI Agent Foundation */}
          <section className="mb-32">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="order-2 lg:order-1 relative h-[400px]">
                <CourseVisual
                  imageSrc="/images/agent2.png"
                  alt="OpenAI Agent Foundation"
              ...
              <div className="order-1 lg:order-2">
                ...
                <h3 className="text-xl font-semibold mb-6 text-accent">AI Agent 준비 & Function Calling 입문</h3>
                <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
                  단순 응답을 넘어선 지능적 Agent. 기존 웹사이트에 챗봇을 추가하고, OpenAI Function Calling으로 첫 AI Agent를 구현합니다.
                </p>
                <ul className="space-y-4">
                  {[
                    "기존 웹사이트 챗봇 UI 추가 및 Supabase 연결",
                    "OpenAI Function Calling 개념 및 API 설정",
                    "첫 번째 함수: 상품 조회 Agent 구현",
                    "AI 자율 판단 테스트 및 개선"
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-3">
          ...
          <section className="mb-32">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <h3 className="text-xl font-semibold mb-6 text-primary">복수 함수 & 지능형 Agent 완성</h3>
                <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
                  스스로 도구를 사용하는 AI. 복수 함수를 추가하고, AI가 자율적으로 판단하고 실행하는 완전한 지능형 Agent를 완성합니다.
                </p>
                <ul className="space-y-4">
                  {[
                    "복수 함수: 주문 생성 & 조회 Agent 구현",
                    "6개 함수 자율 실행 시스템 완성",
                    "대화 맥락 기억 및 오류 처리 강화",
                    "자연어 이해 및 UX 개선"
                  ].map((item, idx) => (
              ...
              <div className="relative h-[400px]">
                <CourseVisual
                  imageSrc="/images/agent3.png"
                  alt="Advanced AI Agent"
                  title="Multi-Function AI Agent"
                  sub="Week 3"
                  icon={BrainCircuit}
                />
              </div>
          ...
          {/* Week 4: Automation & Portfolio */}
          <section className="mb-32">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="order-2 lg:order-1 relative h-[400px]">
                <CourseVisual
                  imageSrc="/images/agent4.png"
                  alt="Automation & Portfolio"
              ...
              <div className="order-1 lg:order-2">
                <Badge className="mb-4" variant="outline">4주차</Badge>
                <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent">
                  Automation & Portfolio
                </h2>
                <h3 className="text-xl font-semibold mb-6 text-accent">n8n 자동화 & 최종 완성</h3>
                <p className="text-muted-foreground mb-8 text-lg leading-relaxed">
                  모든 시스템을 하나로. n8n 워크플로우로 완전 자동화를 구축하고, 포트폴리오를 완성합니다.
                </p>
                <ul className="space-y-4">
                  {[
                    "n8n 기초 및 이메일/Slack 자동화 구축",
                    "전체 시스템 통합 테스트 및 디버깅",
                    "UX 개선 및 고급 기능 추가",
                    "포트폴리오 문서 완성 (Gemini AI 활용)"
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-accent/10 flex items-center justify-center shrink-0 mt-0.5">
                        <CheckCircle size={14} className="text-accent" />
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <ul className="space-y-3 text-amber-900/80 dark:text-amber-200/80 text-sm">
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 bg-amber-500 rounded-full mt-1.5"></div>
                      <span>실습을 위해 Chatling, Cursor AI와 Supabase 무료 계정 생성이 필요합니다.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 bg-amber-500 rounded-full mt-1.5"></div>
          ...
          <section id="outcomes" className="mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { title: "포트폴리오 완성", desc: "OpenAI 기반 지능형 쇼핑몰 AI Agent라는 완성된 포트폴리오를 확보합니다.", icon: <Sparkles className="w-5 h-5 text-primary" /> },
                { title: "Function Calling 마스터", desc: "AI가 스스로 함수를 선택하는 최신 Agent 기술 구현 능력", icon: <Layers className="w-5 h-5 text-primary" /> },
                { title: "AI 협업 개발", desc: "Cursor AI, Gemini를 활용한 효율적인 AI 협업 개발 역량", icon: <MessageSquare className="w-5 h-5 text-primary" /> },
