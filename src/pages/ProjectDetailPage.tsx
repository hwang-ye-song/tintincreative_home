...
const ProjectDetailPage = () => {
  ...
  const getOptimizedImageUrl = (url: string | null) => {
    if (!url) return null;
    // Supabase Storage 이미지 최적화 (width=800으로 리사이즈)
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta property="og:image" content={getOptimizedImageUrl(project.image_url) || ''} />
          ...
          <div className="space-y-6">
            ...
            {project.image_url && (
              <div className="w-full aspect-video rounded-lg overflow-hidden bg-muted">
                <img
                  src={getOptimizedImageUrl(project.image_url) || project.image_url}
                  alt={project.title}
